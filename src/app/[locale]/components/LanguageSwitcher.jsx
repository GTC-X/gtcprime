...
const LanguageSwitcher = () => {
  ...
  return (
    ...
    >
      {/* Trigger */}
      <div className="flex items-center gap-2 px-3 py-[6px] bg-secondary text-white rounded-full shadow-md text-sm cursor-pointer border border-[#b688565b] border-opacity-10 mb-1">
        ...
        >
          {languages.map((lang) => (
            <button
              ...
              className="flex items-center gap-2 w-full text-xs md:text-sm text-white hover:bg-[#1f2773] px-3 py-2 border-b cursor-pointer border-[#ffffff3a]"
            >
              {lang.label}
            </button>
          ))}
